                                                                        ...
                                                                        <ul class="menu">
                                                                            ...
                                                                            @if (!empty($brand_inc))
                                                                                ...
                                                                                @foreach ($brand_inc as $r_inc)
                                                                                    ...
                                                                                    @if ($count > 0)
                                                                                        <li id="brand_dispay_search_index{{ $r_inc->brand_id }}">
                                                                                            <label class="check-container">{{ $r_inc->brand_name }} <span
                                                                                                    class="count" id="show-count-brand_search_index{{ $r_inc->brand_id }}">({{ $count }})</span>
                                                                            ...
                                                                            <div id="morebrands" class="collapse">
                                                                                @if (!empty($brand_inc2))
                                                                                    @foreach ($brand_inc2 as $r_inc)
                                                                                        ...
                                                                                        @if ($count > 0)
                                                                                            <li id="brand_dispay_search_index{{ $r_inc->brand_id }}"><label class="check-container">{{ $r_inc->brand_name }} <span
                                                                                                        class="count" id="show-count-brand_search_index{{ $r_inc->brand_id }}">({{ $count }})</span>
                                                                                                    <input type="checkbox" class="brand_id"
                                                                                    ...
                                                                                    @if (!empty($feature_inc_item))
                                                                                        @foreach ($feature_inc_item as $r_incitem)
                                                                                            ...
                                                                                            @if (count($product_count) > 0)
                                                                                                {{-- @if ($count > 0) --}}
                                                                                                <li id="feature_dispay_search_index{{ $r_incitem->id }}" style="display: block;"><label class="check-container">{{ $r_incitem->name }} <span
                                                                                                            class="count" id="show-count-feature_search_index{{ $r_incitem->id }}">({{ count($product_count) }})</span>
