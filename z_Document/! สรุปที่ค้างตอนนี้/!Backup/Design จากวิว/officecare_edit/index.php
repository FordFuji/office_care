                        ...
                        <div class="banner_slide owl-carousel owl-theme">
                            ...
                            <div class="item">
                                ...
                                <div class="d-block d-sm-block d-md-block d-lg-none d-xl-none">
                                    <img src="images/banner_mb.png" alt="">
                                </div>
                            </div>
                            <?php } ?>
                        </div>
                                ...
                                <div class="qtyAddcart" style="display:none;">
                                    <div class="qty_group_cart">
                                        <div class="input-group"> 
                                            ...
                                            <input id="CC-prodDetails-quantity" type="text" name="quant[<?php echo $i;?>]" class="form-control input-number" value="1" min="0" max="100"/>
                                            <span class="input-group-btn">
                                                <button id="qty-plus" type="button" class="btn btn-default btn-number" data-type="plus" data-field="quant[<?php echo $i;?>]">
