                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-6 g-0">
                                <div class="row mt-3">
                                    <div class="col-lg-3 g-0">
                                        <div class="mainmenu">
                                            <li><a href="product_index.php"><i class="fi fi-rr-apps"></i> สินค้า</a></li>
                                            <li><a href="service.php"><i class="fi fi-rr-apps"></i> บริการ</a></li>
                                        </div>
                                    </div>
                                    <div class="col-lg-9">
                                        <div class="searchtop">
                            ...
                            <div class="col-lg-3 text-end">
                                <div class="acctmenu_topmenu mt-3">
                                    <ul>
                                        <li class="topcart"><a href="cart.php"><i class="fi fi-rr-shopping-cart"></i> ฿
                                                2,000.00
                                                <span>2</span></a></li>
                                        <li class="wishlist"><a href="account_wishlist.php"><i
                                                        ...
                                                        <div class="formdefault mt-4">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-floating mb-3">
                                                                        <input type="name" class="form-control"
                                                                            id="floatingInput" ห placeholder="นามสกุล">
                                                                ...
                                                                <div class="col-lg-12 text-center mt-4 mb-4">
                                                                    ...
                                                                    <a href="#" class="btn btn-facebook"><img
                                                                            src="images/fb-icon.png" alt="">
                                                                        เข้าสู่ระบบด้วย
                                                                        Facebook</a>
                                                                    <div class=" contentbl sizesm mt-4">
                                                                        เป็นสมาชิกอยู่แล้ว? <a href="#"
                                                                            class="linkorg btn_login">เข้าสู่ระบบ <i
